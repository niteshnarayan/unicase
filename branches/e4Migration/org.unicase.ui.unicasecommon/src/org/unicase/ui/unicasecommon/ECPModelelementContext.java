...
public interface ECPModelelementContext {
	 ...
	 */
	void addModelElementContextListener(
			ModelElementContextListener modelElementContextListener);
	 ...
	 *            the {@link ModelElementContextListener}
	 */
	void removeModelElementContextListener(
			ModelElementContextListener modelElementContextListener);
	 ...
	 * Could exclude {@link AssociationClassElement}'s.
	 * 
	 * @param clazz
	 *            the type
	 * @param association
	...
	/**
	 * If a {@link EObject} is contained in this context and can be therefore
	 * referenced by the {@link EObject} defining the context.
	 * 
	 * @param eObject
	 *            the {@link EObject}
