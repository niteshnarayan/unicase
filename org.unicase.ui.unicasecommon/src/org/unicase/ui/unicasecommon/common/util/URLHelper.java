...
public final class URLHelper {
	 ...
	 */
	public static String getHTMLLinkForModelElement(ESUsersession userSession,
			ProjectSpace projectSpace, int style) {
		EObject modelElement = projectSpace.getProject().getModelElement(
				OrgUnitHelper.getUser(projectSpace.getProject(),
						userSession.getUsername()).getModelElementId());
	...
	public static String getHTMLLinkForModelElement(EObject modelElement,
		...
		ret.append("/");
		String name = new AdapterFactoryLabelProvider(
				new ComposedAdapterFactory(
						ComposedAdapterFactory.Descriptor.Registry.INSTANCE))
				.getText(modelElement);
