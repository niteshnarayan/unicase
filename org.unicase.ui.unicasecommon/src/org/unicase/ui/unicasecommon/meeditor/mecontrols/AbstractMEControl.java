...
public abstract class AbstractMEControl {
	...
	/**
	 * The default constant in case the widgets decides it shouldn't render the
	 * attribute.
	 */
	...
	/**
	 * Method for applying a custom layout data to widgets, as for
	 * {@link MERichTextControl}.
	 */
	 ...
	 *            the {@link IItemPropertyDescriptor}
	 */
	public void setItemPropertyDescriptor(
			IItemPropertyDescriptor itemPropertyDescriptor) {
